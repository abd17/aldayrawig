...
<div class="row center page products">
       <h3 class="page-title"><img class="right-img" src="img/right.png" /><span>?</span>انجازات النادي<img class="left-img" src="img/left.png" /><a href="index1.php" class="return">العودة للرئيسية</a></h3>
