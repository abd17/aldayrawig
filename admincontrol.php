...
<div class="row center page single">
    <h3 class="page-title"><img class="right-img" src="img/right.png" /><span></span>من نحن<img class="left-img" src="img/left.png" /><a href="index1.php" class="return">العودة للرئيسية</a></h3>
    <div class="col-md-12">
   
        <p><a href="#" class="return"> ------------------- </a>
            
        <a href="news.php" class="return">اضافة اخبار </a>
            
            <a href="#" class="return"> ------------------- </a>
          
             <a href="winadd.php" class="return">اضافة انجازات  </a>
   </li>
            <a href="#" class="return"> ------------------- </a>
            <a href="magazadd.php" class="return">اضافة مقالات  </a>
       
             <a href="#" class="return"> ------------------- </a>
            <a href="matchtimeadd.php" class="return"> اضافة مباراة  </a>
            <a href="#" class="return"> ------------------- </a>
            <a href="playeradd.php" class="return"> اضافة لاعبين  </a>
             <a href="#" class="return"> ------------------- </a>
            <a href="aboutclubadd.php" class="return">  تحديث معلومات النادي  </a>
