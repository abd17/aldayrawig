...
<html lang="en">
   ...
   <div class="row center page contact">
    <h3 class="page-title"><img class="right-img" src="img/right.png" /><span></span>اتصل بنا<img class="left-img" src="img/left.png" /><a href="index1.php" class="return">العودة للرئيسية</a></h3>
...
بيانات الاتصال                  </h4> 
     ...
     <span></span> العنوان :<br/>
             </div>
  <?php
                        $id="SELECT COUNT(*) FROM aboutclub";
                       $query= "select * from aboutclub where id=($id)";
         ...
         <li><div class="data-title">
     <span></span> البريد الالكترونى :<br/>
              </div>
  <?php
                        $id="SELECT COUNT(*) FROM aboutclub";
                       $query= "select * from aboutclub where id=($id)";
